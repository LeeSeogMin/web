...
| 00:05~00:30 | 바이브코딩이란 + AI 코딩의 3대 한계 |
| 00:30~00:55 | Copilot 설치 + 자동완성/Chat 체험 |
| 00:55~01:20 | 라이브 코딩 시연: copilot-instructions.md + 컨텍스트 관리 + 환각 검증법 |
...
> **강의 팁**: Copilot Chat에서 모드를 Ask → Agent로 전환하고, "이 프로젝트에 /about 페이지를 추가해줘"라고 입력하여 Agent가 파일을 탐색하고 코드를 작성하는 과정을 보여준다.
...
**스타터 코드**: `practice/chapter2/starter/` — Ch1 프로필 결과물 + `.github/copilot-instructions.md` 템플릿이 준비되어 있다.
...
**준비물 체크리스트**:
- [ ] GitHub Education 사전 안내 (1주차에 공지 — 승인에 며칠 소요)
- [ ] Copilot 설치 트러블슈팅 가이드
- [ ] copilot-instructions.md 전/후 비교 시연용 프로젝트
- [ ] B회차 스타터 코드 준비 (`practice/chapter2/starter/`)

**수업 후 체크**:
- [ ] 전원 Copilot 설치 완료 확인 (미승인 학생은 Codeium 대안 안내)
- [ ] 전원 copilot-instructions.md 작성 확인
- [ ] Agent Mode/Skills 개념을 이해했는가
