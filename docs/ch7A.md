...
[요구 출력]
1) 수정할 파일 경로 목록
2) `app/layout.js`에서 공통 레이아웃(헤더/푸터 포함) shadcn/ui 적용
...
| ------------- | ------------- | ------------------------- |
| 홈            | `/`           | `app/page.js`            |
| 포스트 목록   | `/posts`      | `app/posts/page.js`      |
| 포스트 상세   | `/posts/[id]` | `app/posts/[id]/page.js` |
| 포스트 작성   | `/posts/new`  | `app/posts/new/page.js`  |
| 로그인        | `/login`      | `app/login/page.js`      |
| 마이페이지    | `/mypage`     | `app/mypage/page.js`     |
...
```tsx
// components/ui/button.js (shadcn/ui가 복사한 코드)
...
> app/posts/page.js에 포스트 목록 페이지를 만들어줘.
