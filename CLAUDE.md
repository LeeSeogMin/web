...
**장 유형별 분량 및 구성비**:
- 기초 이론 장 (Ch3-4): 600-700줄 — 개념 30% + 프롬프트 20% + 코드읽기 40% + 과제 10%
- Copilot/설계 장 (Ch2, Ch7): 500-600줄 — 개념 20% + 실습 가이드 50% + 검증 20% + 과제 10%
- 기술 실습 장 (Ch5-6, Ch8-12): 700-800줄 — 개념 15% + 프롬프트 35% + 코드읽기/검증 40% + 과제 10%
- 프로젝트 장 (Ch13): 400-500줄 — 가이드 30% + 체크리스트 70%
