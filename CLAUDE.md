...
- **수업 형태**: 주 2회 × 90분 (A회차: 강의+시연 / B회차: 개인 실습+코드리뷰)
...
- **현재 단계**: 주 2회 90분 A/B 체계로 전환 중 — 기존 3교시 원고를 A/B 회차로 재구성 필요
...
- ⏳ 기존 3교시 원고 → A/B 회차 분리 재구성 필요 (docs/ch{N}.md → ch{N}A.md + ch{N}B.md + ch{N}C.md)
- ⏳ practice/ 스타터 코드 구조 추가 필요 (starter/ + complete/)
- ⏳ ms-word/ 의존성 설치 필요 (npm install)

---

**마지막 업데이트**: 2026-02-25
**버전**: 3.0 (주 2회 90분 A/B 체계 전환)
